...
export const timelineData: TimelineEvent[] = [
  ...
  },
  {
    ...
    important: true,
    source: '머니투데이',
    link: 'https://news.mt.co.kr/mtview.php?no=2025061815001844242'
  },
  {
    date: '2025.06.20',
    title: '유심 교체 완료, 신규 영업 재개 평가 중',
    description: '과학기술정보통신부는 SK텔레콤의 유심 교체가 사실상 완료되었으나, 신규 영업이 곧바로 재개되지는 않을 것으로 보았다. 과기정통부 관계자는 "새로운 예약시스템이 어떻게 작동하는지 며칠 보고 평가가 필요할 것 같다"고 말했다. 또한 개인정보 분쟁조정위원회는 SK텔레콤을 상대로 신청된 집단분쟁조정 2건에 대해 개시를 의결했다.',
    category: 'government',
    source: '과학기술정보통신부'
  },
  {
    date: '2025.06.23',
    title: '신규영업 중단 해제 발표',
    description: '과학기술정보통신부는 SK텔레콤에 부여한 신규영업 중단을 24일부터 해제한다고 밝혔다. 과기정통부는 "SK텔레콤이 향후 교체 수요 이상으로 유심 물량을 확보할 수 있고, 새로운 예약시스템이 시행·안정화됐다"며 "유심 부족 관련 SK텔레콤에 내린 행정지도의 목적이 충족돼 신규영업 중단을 해제했다"고 밝혔다.',
    category: 'government',
    important: true,
    source: '과학기술정보통신부'
  },
  {
    date: '2025.06.24',
    title: '개인정보보호위원회 처분 결과 수개월 안 발표 예정',
    description: '고학수 개인정보보호위원회 위원장은 "SK텔레콤 해킹 사태에 대한 조사 윤곽이 내부적으로 잡히고 있다"며 "처분 결과를 수개월 안에 낼 수 있을 것"이라고 밝혔다.',
    category: 'government',
    source: '개인정보보호위원회'
  },
  {
    date: '2025.06.30',
    title: '민관 합동 조사 완료, 이번 주 발표 예정',
    description: '배경훈 과학기술정보통신부장관 후보자는 민관 합동 조사가 끝났다고 보고받았다며 "조사 결과에 따라 대응책을 정리하고 있으며 이번 주 내로 발표하는 것으로 안다"고 밝혔다.',
    category: 'government',
    source: '과학기술정보통신부'
  },
  {
    date: '2025.07.01',
    title: '7월 4일 국회 보고 예정',
    description: '과학기술정보통신부가 오는 4일 SK텔레콤 유심 해킹 사태에 대한 민관합동조사결과를 국회에 보고한다.',
    category: 'government',
    source: '과학기술정보통신부'
  },
  {
    date: '2025.07.03',
    title: '이재명 대통령 위약금 관련 발언',
    description: '이재명 대통령은 수석보좌관회의에서 SK텔레콤 해킹 사고에 대한 대응 현황을 보고받으며 위약금과 관련해 "계약 해지 과정에서 회사의 귀책 사유로 피해자들이 손해를 보는 일이 없어야 한다"고 강조했다. 강유정 대통령실 대변인은 "대통령님은 법률을 피해자 쪽에 적극적으로 해석해야 한다는 말씀을 하셨다"며 "계약 해지의 위약금 부분에 있어서는 국민의 이익을 최대한 반영해야 한다는 말씀"이라고 설명했다.',
    category: 'government',
    important: true,
    source: '대통령실'
  },
  {
    date: '2025.07.04',
    title: '민관합동조사 최종 결과 발표 및 위약금 면제 결정',
    description: '과학기술정보통신부는 민관 합동 조사단의 최종 조사에서 해커의 공격이 2021년부터 이뤄졌으며 SK텔레콤이 2022년 자체 조사로 침해 사실을 발견하고도 제대로 조치하지 않으면서 사태를 키운 사실이 드러났다고 밝혔다. 정부는 휴대전화 복제에 악용될 수 있는 단말기식별정보(IMEI) 역시 유출되지 않았다고 확언할 수 없지만, 복제폰으로 인한 2차 피해 우려는 하지 않아도 된다고 강조했다. 또한 정부는 이번 사고 책임이 SK텔레콤에 있고 계약상 중요한 안전한 통신을 제공해야 하는 의무를 위반했으므로 위약금 면제 규정에 해당한다고 공식 발표했다. 유상임 과기정통부 장관은 "이번 SK텔레콤 침해사고는 국내 통신 업계뿐만 아니라 네트워크 인프라 전반의 정보 보호에 경종을 울리는 사고였다"고 밝혔다.',
    category: 'government',
    important: true,
    source: '과학기술정보통신부'
  }
