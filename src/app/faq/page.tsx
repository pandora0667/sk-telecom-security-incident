            ...
            <div className="bg-white rounded-xl shadow-md p-6 md:p-8 border border-blue-100">
              ...
              <div className="space-y-2">
                <FAQItem 
                  ...
                  answer={
                    <p>
                      현재 SK텔레콤 해킹 사태와 관련해 집단소송을 진행하거나 준비 중인 로펌은 대륜, 로고스, 로집사, 로피드, 
                      거북이, 노바 등 10여 곳이 있습니다. 소송에 참여하려면 이들 로펌의 홈페이지나 소송 참여 접수 페이지를 통해 
                      신청할 수 있습니다. 소송 참여 시 필요한 정보와 서류는 각 로펌마다 안내하고 있으니 참고하시기 바랍니다.
                    </p>
                  }
                />
